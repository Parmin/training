...
public class StoreDao {
    ...
    private static Address docToAddress(Document document){
        return new Address(document.getString("address"), document.getString("address2"),
        document.getString("city"), document.getString("state"),
        Integer.toString(document.getInteger("zip")), document.getString("country"));
    }
    ...
    private static Store docToStore(Document document) {
        ...
        Address address = docToAddress((Document)document.get("address"));
