...
public class StoreController {
	...
	public StoreController(Configuration cfg, Connection connection, MongoDatabase mongoMartDatabase) {
		...
		get("/item", (request, response) -> {
			...
			HashMap<String, Object> attributes = buildItemResponse(Utils.getIntFromString(itemid), itemDao, reviewDao, mongoReviewDao);
		...
		get("/add-review", (request, response) -> {
			...
			HashMap<String, Object> attributes = buildItemResponse(itemid, itemDao, reviewDao, mongoReviewDao);
			return new ModelAndView(attributes, "item.ftl");
		}, new FreeMarkerEngine(cfg));
