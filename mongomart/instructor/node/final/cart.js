...
function CartDAO(database) {
    ...
    this.getCart = function(userId, callback) {
        ...
        */
        ...
        // TODO-lab5 Replace all code above (dummy code used to populate
        // fake cart).
    ...
    this.itemInCart = function(userId, itemId, callback) {
         ...
         *
         * While it is not necessary, it is easiest to solve this problem using 
         * the $ operator. You can use $ in a projection document in your call 
         * to find() as a means of selecting the matching item. Again, take care 
         * to pass only the matching item (not an array) to the callback. See:
    ...
    this.updateQuantity = function(userId, itemId, quantity, callback) {
        ...
        * TODO-lab7
        *
        * LAB #7: Update the quantity of an item in the user's cart by setting
        * quantity to the value passed in the quantity parameter. If the value 
        * passed for quantity is 0, remove the item from the cart.
        *
        * Pass the updated document to the callback.
        *
