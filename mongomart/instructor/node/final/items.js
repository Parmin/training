...
function ItemDAO(database) {
    ...
    this.getItems = function(category, page, itemsPerPage, callback) {
        ...
        var queryDoc = this.categoryQueryDoc(category);
        this.findItems(queryDoc, page, itemsPerPage, callback);
    }
    ...
    this.searchItems = function(query, page, itemsPerPage, callback) {
         ...
         * TODO-lab2
         *
         * LAB #2: Perform a text search against the item collection, limit by itemsPerPage and
         * skip by (page * itemsPerPage).
         *
         */

        var queryDoc = this.searchQueryDoc(query);
        this.findItems(queryDoc, page, itemsPerPage, callback);
    }
    ...
    this.getNumSearchItems = function(query, callback) {
        ...
        * TODO-lab2
        *
        * LAB #2: Count the items in the "item" collection based on a text search. 
    ...
    this.getRelatedItems = function(callback) {
        ...
        cursor.limit(4);
        cursor.toArray(function(err, relatedItems) {
            assert.equal(null, err);
    ...
    this.findItems = function(queryDoc, page, itemsPerPage, callback) {
    ...
    this.categoryQueryDoc = function(category) {
        var queryDoc;
        if (category == "All") {
            queryDoc = {};
        } else {
    ...
    this.searchQueryDoc = function(query) {
        var queryDoc;
        if (query.trim() == "") {
            queryDoc = {};
        } else {
    ...
    this.createDummyItem = function() {
        ...
        var item = {
            ...
            stars: 0,
            category: "Apparel",
            imgUrl: "/img/products/hoodie.jpg",
            price: 29.99,
            reviews: []
        };
